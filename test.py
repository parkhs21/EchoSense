...
#url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=37.566535,126.97796919999996&radius=1000&type=restaurant&key=AIzaSyBETTT5fvImfLfRr86Xo4Y1ELWIBXV86NY"
#payload={}
#headers = {}
...
client = OpenAI(api_key='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')
...
def call_google_places_api(user_id, place_type, food_preference=None):
    try:
        ...
        API_KEY = 'AIzaSyBETTT5fvImfLfRr86Xo4Y1ELWIBXV86NY'  # retrieve API key from environment variable
        LOCATION = f"{lat},{lng}"
